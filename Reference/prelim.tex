...
\subsection{Type Checking Data Types}
\label{sec:datatypes}
...
It returns the updated versions of the first 6 inputs. $\boldsymbol{cP}$ and $\boldsymbol{cPs}$ represent $checkPattern$ and $checkPats$ respectively:
