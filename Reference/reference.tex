...
$inst$ also calls the function that checks that an atomic value $a$ does not occur in a value $v$:
...
\begin{enumerate}
  ...
  \item a set of flexible generic values.
...
\begin{figure}[H]
  \begin{equation*}
    \begin{aligned}
      inst \: k \: [dot_1,\dots,dot_n] \: v_1 \: v_2 & = & \\
    \end{aligned}
  \end{equation*}
